...
print(f'Best Navigational Solution: rho_v={rho_v*v_factors[f_nav]},'\
...
plot_bundle(nav_x)
if f_nav != f_curr:
    print(f'Best Current Solution: rho_v={rho_v*v_factors[f_curr]},'\
            f' rho_c={rho_c*c_factors[f_curr]}')
    print(f'Path error: {errmap[0, f_curr]}\n'\
