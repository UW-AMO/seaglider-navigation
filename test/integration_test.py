...
viz.vehicle_speed_plot(sol.x, ddat, times, depths)
viz.current_depth_plot(sol.x, adat, ddat, direction='both')
viz.vehicle_posit_plot(sol.x, ddat, times, depths, dead_reckon=True)

mdat = dp.load_mooring('CBX16_T3_AUG2017.mat')
viz.current_depth_plot(sol.x, adat, ddat, direction='both', mdat=mdat)
